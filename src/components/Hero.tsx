        ...
        <div ref={leftColRef} className="lg:col-span-6 flex flex-col space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-3.5 pt-1">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-white text-zinc-900 hover:bg-zinc-50 border-2 border-zinc-900 rounded-xl px-5 py-3 font-bold text-sm shadow-[3px_3px_0px_#1e1e1e] neo-btn cursor-pointer"
            >
