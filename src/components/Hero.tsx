...
import { ArrowRight, Heart, Smile, Star, FileText } from "lucide-react";
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3 pt-1 flex-wrap">
            ...
            {onOpenResume && (
              <button
                ...
                className="inline-flex items-center justify-center gap-2 bg-[#c3e3c3] hover:bg-[#aee0ae] text-zinc-950 border-2 border-zinc-900 rounded-xl px-4 py-3 font-bold text-sm shadow-[3px_3px_0px_#1e1e1e] neo-btn cursor-pointer w-full sm:w-auto"
              >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-white text-zinc-900 hover:bg-zinc-50 border-2 border-zinc-900 rounded-xl px-4 py-3 font-bold text-sm shadow-[3px_3px_0px_#1e1e1e] neo-btn cursor-pointer w-full sm:w-auto"
            >
